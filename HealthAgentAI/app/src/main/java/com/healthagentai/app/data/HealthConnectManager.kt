...
import androidx.health.connect.client.records.StressRecord
...
class HealthConnectManager(private val context: Context) {
    ...
    suspend fun readStressRecords(start: Instant, end: Instant): List<StressRecord> {
        val request = ReadRecordsRequest(
     ...
     * [com.healthagentai.app.presentation.screen.recordlist.RecordType] enum.
     */
